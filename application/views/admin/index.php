                 ...
                 <div class="card-header py-3 d-flex flex-rowz align-items-center justify-content-between">
                   ...
                   <div class="dropdown no-arrow">
                     ...
                     <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                       ...
                       <a class="dropdown-item" href="<?= base_url('master') ?>">Department List</a>
                     </div>
                   </div>
                 </div>
                 <!-- Card Body -->
             ...
             <div class="col p-0">
               <div class="card border-left-dark shadow h-100 py-2">
                 <div class="card-body">
                   <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                       <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Admin - Web Programming</div>
                       <div class="h5 mb-0 font-weight-bold text-gray-800">RPTRA Administrator</div>
                     </div>
                     <div class="col-auto">
